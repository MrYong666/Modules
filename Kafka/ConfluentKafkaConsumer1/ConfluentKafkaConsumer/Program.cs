    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
                    ...
                    .Build())
            {
                ...
                consumer.Assign(new List<TopicPartitionOffset>() { new TopicPartitionOffset("Test_2020", 1, 10) });
                ...
                try
                {
                    while (true)
                    {
                        try
                        {
                            ...
                            {
                                Console.WriteLine($"1  Received message at {consumeResult.TopicPartitionOffset}: {consumeResult.Value}");
                            }
